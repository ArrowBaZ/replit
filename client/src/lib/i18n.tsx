...
const translations = {
  en: {
    ...
    notifPrefMeetingUpdate: "Meeting updates",
    notifPrefMeetingUpdateDesc: "Show a pop-up when a meeting is cancelled or rescheduled.",
    notifPrefItemPricing: "Item pricing events",
    notifPrefItemPricingDesc: "Show a pop-up when an item pricing decision is made (approved or declined).",
    ...
    toastMeetingCancelled: "Meeting cancelled",
    toastMeetingRescheduled: "Meeting rescheduled",
    ...
    verifyEmailDescription: "We've sent a verification code to your email. Enter it below to confirm your email address.",
    ...
    resetEmailSentDescription: "If an account exists with that email, you'll receive a password reset link. Check your inbox and follow the instructions.",
  ...
  fr: {
    ...
    notifPrefMeetingUpdate: "Mises a jour de rendez-vous",
    notifPrefMeetingUpdateDesc: "Afficher une alerte quand un rendez-vous est annule ou reprogramme.",
    notifPrefItemPricing: "Evenements de tarification",
    notifPrefItemPricingDesc: "Afficher une alerte quand une decision de tarification est prise (approuvee ou refusee).",
    ...
    toastMeetingCancelled: "Rendez-vous annule",
    toastMeetingRescheduled: "Rendez-vous reprogramme",
    ...
    verifyEmailDescription: "Nous avons envoyé un code de vérification à votre email. Entrez-le ci-dessous pour confirmer votre adresse email.",
    ...
    resetEmailSentDescription: "Si un compte existe avec cet email, vous recevrez un lien de réinitialisation du mot de passe. Vérifiez votre boîte de réception et suivez les instructions.",
    ...
    invalidResetLink: "Ce lien de réinitialisation du mot de passe est invalide ou a expiré.",

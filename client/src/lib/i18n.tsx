...
const translations = {
  en: {
    ...
    catToutMode: "Tout Mode",
    catVetements: "Clothing",
    catMontrsBijoux: "Watches & Jewellery",
    catAccessoiresBagagerie: "Accessories & Bags",
    catAmeublement: "Furniture",
    catElectromenager: "Home Appliances",
    catDecoration: "Decoration",
    catLingeDeMaison: "Home Linen",
    catElectronique: "Electronics",
    catOrdinateurs: "Computers",
    catTelephonesObjetsConnectes: "Phones & Wearables",
    catLivres: "Books",
    catVins: "Wines",
    catInstrumentsDeMsique: "Musical Instruments",
    catJeuxJouets: "Games & Toys",
    catVelos: "Bicycles",
  ...
  fr: {
    ...
    catToutMode: "Tout Mode",
    catVetements: "Vêtements",
    catMontrsBijoux: "Montres & Bijoux",
    catAccessoiresBagagerie: "Accessoires & Bagagerie",
    catAmeublement: "Ameublement",
    catElectromenager: "Électroménager",
    catDecoration: "Décoration",
    catLingeDeMaison: "Linge de maison",
    catElectronique: "Electronique",
    catOrdinateurs: "Ordinateurs",
    catTelephonesObjetsConnectes: "Téléphones & Objets connectés",
    catLivres: "Livres",
    catVins: "Vins",
    catInstrumentsDeMsique: "Instruments de musique",
    catJeuxJouets: "Jeux & Jouets",
    catVelos: "Vélos",
